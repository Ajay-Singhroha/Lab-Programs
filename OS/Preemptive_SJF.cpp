...
#include <cstring>
using namespace std;
void display_gnattChart(Process p[],string s);
...
string calculate_TAT(Process p[],int n)                                        // Calculate TAT of processes
{
...
int main()
{
    ...
    sort(p,n);
    string s=calculate_TAT(p,n);


    calculate_WT_RT(p,n);

    display_gnattChart(p,s);
